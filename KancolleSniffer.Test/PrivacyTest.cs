...
namespace KancolleSniffer.Test
{
    ...
    public class PrivacyTest
    {
        ...
        public void RemoveToken()
        {
            ...
            PAssert.That(() => Privacy.RemoveToken(request) == "api%5Fverno=1&api%5Fport=0123456789", "トークンが中間");
            const string request2 = "api%5Fverno=1&api%5Ftoken=0123456abcdef";
            PAssert.That(() => Privacy.RemoveToken(request2) == @"api%5Fverno=1", "トークンが末尾");
            const string request3 = "api%5Ftoken=0123456abcdef&api%5Fverno=1";
            PAssert.That(() => Privacy.RemoveToken(request3) == @"api%5Fverno=1", "トークンが先頭");
            const string request4 = "api%5Ftoken=0123456abcdef";
            PAssert.That(() => Privacy.RemoveToken(request4) == "", "トークン単独");
            const string request5 = "api%5Fbtime=83026279&api%5Ftoken=0123456abcdef&api%5Fverno=1";
            PAssert.That(() => Privacy.RemoveToken(request5) == "api%5Fverno=1", "戦闘APIの時刻印を削除");
        }
        ...
        public void RemoveToken2()
        {
            ...
            PAssert.That(() => Privacy.RemoveToken(request) == "api_verno=1&api_port=0123456789", "トークンが中間");
            var request5 = "api_btime=83026279&api_token=0123456abcdef&api_verno=1";
            PAssert.That(() => Privacy.RemoveToken(request5) == "api_verno=1", "戦闘APIの時刻印を削除");
        }
        ...
        public void RemoveName()
        {
            ...
            PAssert.That(() => Privacy.RemoveName(response1) == result1);
